...
function props(overrides: Partial<LessonConversationNavigationProps> = {}): LessonConversationNavigationProps { return { owner: { kind: 'lesson', lesson: identity }, ownerLabel: '电路', conversations: [record('a', '主讨论'), record('b', '实验')], currentId: 'a', operation: vi.fn(async () => ({})), onSelect: vi.fn(async () => undefined), onRecordsChange: vi.fn(), onDeleted: vi.fn(), ...overrides } }
