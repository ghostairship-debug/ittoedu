  ...
  const stdout = execFileSync(
    ...
    [resolveTsxCli(), '--input-type=module', '--eval', TIMEZONE_PROBE_PROGRAM],
    {
      ...
      env: {
        ...process.env,
        TZ: timezone,
        COURSE_FACTORY_MODULE_URL: moduleUrl('src/core/course/createCourseProject.ts'),
        ...
        COURSE_ARCHIVE_MODULE_URL: moduleUrl('src/core/drivers/codecs/courseProjectArchive.ts'),
