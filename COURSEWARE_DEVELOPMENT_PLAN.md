...
| 上下文共编 | Markdown 三 CLI 真实选区链、Flow Luna 精确修改/历史/重开/断网 HTML 通过 |
| 2.0 已有分项 | 原生课件三 CLI、PPTX 7 项、保全 27 项、跨文档共编/冲突/切根 3 项通过，见[本轮记录](docs/development-plan/reviews/2026-09-21-r20-contextual-acceptance.md) |
