...
export function ProductivityDialog({ pptxOnly = false, getContext, getAssetFiles, onCommit, onClose }: ProductivityDialogProps) {
  ...
  return <div className="modal-backdrop"><section role="dialog" aria-modal="true" aria-label={pptxOnly ? '导入 PPT' : '设计生产力'} style={{ background: 'var(--panel-bg, #fffefa)', color: 'inherit', padding: 24, borderRadius: 12, width: 'min(880px, 92vw)', maxHeight: '88vh', overflow: 'auto' }}>
