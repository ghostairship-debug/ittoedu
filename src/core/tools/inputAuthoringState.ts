...
/** Shared managed-input copy rule for clipboard and full-scene duplication. */
export function remapDuplicatedInputState(draft: CourseProjectDocument, duplicate: LayerItem, stateKeys: Map<string, string>, ruleIds: ReadonlyMap<string, string>): void {
