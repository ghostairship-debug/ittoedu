...
export const aiTaskSchema = z.object({
  ...
  execution: z.object({
    ...
    // Last precise producer cause, bound to its target and failing input field.
    // Opaque rejection envelopes do not replace that evidence.
    lastReasonKey: z.string().max(200).nullable().optional(),
