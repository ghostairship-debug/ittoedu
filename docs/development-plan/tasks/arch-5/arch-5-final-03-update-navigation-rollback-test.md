...
- [ ] exact target and rollback call order is asserted
- [ ] no product source or unrelated test changes
- [ ] exact focused case passes once
...
- Pending the one-hunk test correction and exact-case validation.
