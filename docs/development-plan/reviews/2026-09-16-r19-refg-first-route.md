...
范围：[产品可用性方案第 6 节](../R19_PRODUCT_USABILITY_IMPROVEMENT_PLAN.md#6-下一批首次选路原因驱动恢复与真实结果验证待实施)的 R/E/F/G 四个产品工作包。本批只做产品代码与免费/真实宿主检查，未运行三通道付费自然任务；050/060 与 Owner accepted 保持独立。未提交、未建标签。
