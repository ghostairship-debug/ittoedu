...
**当前实施入口（2026-09-17）：先完成[前端专项 F00–F08](../../R19_FRONTEND_SPECIAL_IMPLEMENTATION_PLAN.md)，再核对 050/060 剩余验收。** 下述旧课例入口与固定布局已由[已确认 V3.1](../../../../双形态UI设计/00-设计说明.md)替代；课程文件、三格式消费、真实阶段确认等验收保持。任务 DAG 是能力与验收规格，不是本轮待重做清单。

2026-09-17 U01–U10 已实施，见[工程记录](../../reviews/2026-09-17-r19-usability-execution.md)；其后[有限收尾](../../reviews/2026-09-17-r19-limited-closeout.md)已停止。050 完整教师代表链与 060 候选门仍未完成，前端专项完成后接续核对。首次表现与最终正确结果、完整耗时分列，不重开未受影响的有效课例证据。
