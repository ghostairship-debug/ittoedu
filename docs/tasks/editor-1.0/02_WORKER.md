...
> **本协议不再用于当前派工。** 当前自动多智能体、文件防火墙、最小验证与回滚规则见 [最终详细执行方案](../../development-plan/README.md) 和 [自动执行工作流](../../development-plan/40-development/00_SINGLE_MAINTAINER_AI_WORKFLOW.md)。本文件只解释历史 T/P/Q/F/G 工人的约束。
